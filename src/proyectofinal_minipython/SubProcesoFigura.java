...
public class SubProcesoFigura extends JPanel {
    ...
    public SubProcesoFigura(int sizeX, int sizeY, int locX, int locY, Font font) {
        this.sizeX = sizeX;
        this.sizeY = sizeY;
        this.locX = locX;
        this.locY = locY;
    ...
    public SubProcesoFigura(JPanel c) {
        super();
        this.copy(c);
    }
    ...
    public void copy(JPanel c) {
        ...
        SubProcesoFigura newC = (SubProcesoFigura) c;
